...
<div class="form-step active" id="step1">
  ...
  <select name="masters_program" class="select2" style="width:100%;">
    ...
    <option value="Master of Science – Data Science – Analytics of Business Decisions">Master of Science – Data Science – Analytics of Business Decisions</option>
    <option value="Master of Science – Data Science – Health Analytics">Master of Science – Data Science – Health Analytics</option>
    <option value="Master of Science – Data Science – Analytics and Modeling">Master of Science – Data Science – Analytics and Modeling</option>
    <option value="Master of Science – Computer Science">Master of Science – Computer Science</option>
  </optgroup>

  <optgroup label="🔐 Cybersecurity">
    <option value="Master of Science – Cybersecurity – Security Management">Master of Science – Cybersecurity – Security Management</option>
    <option value="Master of Science – Cybersecurity – Data Security">Master of Science – Cybersecurity – Data Security</option>
    <option value="Master of Science – Cybersecurity – Software and System Security">Master of Science – Cybersecurity – Software and System Security</option>
    <option value="Master of Science – Cybersecurity – National Security">Master of Science – Cybersecurity – National Security</option>
  </optgroup>

  <optgroup label="🧮 Sciences">
    <option value="Master of Science – Mathematical Sciences">Master of Science – Mathematical Sciences</option>
    <option value="Master of Science – Environmental Science (Thesis)">Master of Science – Environmental Science (Thesis)</option>
    <option value="Master of Science – Environmental Science (Non-Thesis)">Master of Science – Environmental Science (Non-Thesis)</option>
    <option value="Master of Science – Biology (Thesis)">Master of Science – Biology (Thesis)</option>
    <option value="Master of Science – Biology (Non-Thesis)">Master of Science – Biology (Non-Thesis)</option>
  </optgroup>

  <optgroup label="⚖ Legal & Criminal Justice">
    <option value="Master of Science – Criminal Justice">Master of Science – Criminal Justice</option>
  </optgroup>

  <optgroup label="🏃 Health & Movement">
    <option value="Master of Science – Athletic Training">Master of Science – Athletic Training</option>
    <option value="Master of Science – Movement Sciences & Health – Exercise Science">Master of Science – Movement Sciences & Health – Exercise Science</option>
  </optgroup>

  <optgroup label="⚙ Engineering">
    <option value="Master of Science – Engineering">Master of Science – Engineering</option>
  </optgroup>

  <optgroup label="🌍 Humanities & Social Sciences (Master of Arts)">
    <option value="Master of Arts – International Affairs">Master of Arts – International Affairs</option>
    <option value="Master of Arts – Political Science">Master of Arts – Political Science</option>
    <option value="Master of Arts – English – Creative Writing">Master of Arts – English – Creative Writing</option>
    <option value="Master of Arts – English – Literature">Master of Arts – English – Literature</option>
    <option value="Master of Arts – History – Traditional History">Master of Arts – History – Traditional History</option>
    <option value="Master of Arts – History – Early American Studies">Master of Arts – History – Early American Studies</option>
    <option value="Master of Arts – History – Public History">Master of Arts – History – Public History</option>
    <option value="Master of Arts – Anthropology – Historical Archaeology">Master of Arts – Anthropology – Historical Archaeology</option>
    <option value="Master of Arts – Anthropology">Master of Arts – Anthropology</option>
  </optgroup>

  <optgroup label="🧠 Psychology (Master of Arts)">
    <option value="Master of Arts – Psychology – Industrial-Organizational">Master of Arts – Psychology – Industrial-Organizational</option>
    <option value="Master of Arts – Psychology – Counseling Psychology – Licensed">Master of Arts – Psychology – Counseling Psychology – Licensed</option>
  </optgroup>

  <optgroup label="📢 Communication (Master of Arts)">
    <option value="Master of Arts – Strategic Communication and Leadership">Master of Arts – Strategic Communication and Leadership</option>
  </optgroup>

  <optgroup label="🏫 Master of Education (M.Ed.)">
    <option value="Master of Education – College Student Affairs Administration">Master of Education – College Student Affairs Administration</option>
  </optgroup>

  <optgroup label="👥 Master of Social Work (M.S.W.)">
    <option value="Master of Social Work">Master of Social Work</option>
    <option value="Master of Social Work – Advanced Standing">Master of Social Work – Advanced Standing</option>
  </optgroup>
  ...
  <optgroup label="💼 Master of Business Administration (MBA)">
    ...
    <option value="MBA – Supply Chain Logistics Management">MBA – Supply Chain Logistics Management</option>
    <option value="MBA – Aviation Economics">MBA – Aviation Economics</option>
    <option value="MBA – Hospitality and Tourism Leadership">MBA – Hospitality and Tourism Leadership</option>
  </optgroup>
</select>
</div>
...
<script>
let lastMessageId = 0; // Track latest message ID

function loadChatMessages(callback = null) {
    $.get('load_chat.php', { 
        ...
        if (response && response.messages && response.messages.length > 0) {
            ...
            response.messages.forEach(function(msg) {
                $('#chat-messages').append(msg.html);
                lastMessageId = msg.id; // update latest ID
            });
...
function openChatWindow() {
    $.get('check_chat_user.php', { user_id: '<?= htmlspecialchars($userId) ?>' }, function(data) {
        if (data && data.saved) {
            $('#chat-login-form').hide();
            $('#chat-window').fadeIn(200, function() {
                loadChatMessages(bindChatInput);
            });
        } else {
...
function saveChatUserInfo() {
    let email = $('#chat_user_email').val().trim();
    let phone = $('#chat_user_phone').val().trim();

    if (!email || !phone) {
        alert('Please enter your email and WhatsApp number.');
        return;
    }

    $.post('save_chat_user.php', {
        user_id: '<?= htmlspecialchars($userId) ?>',
        email: email,
        phone_number: phone
    }, function(response) {
        if (response && response.status === 'success') {
            ...
            alert('Failed to save chat info. Please try again.');
        }
    }, 'json');
}

function sendChatMessage() {
    let message = $('#chat_message_input').val().trim();
    if (!message) return;
    ...
    $.post('send_chat.php', {
        ...
        $('#typing-indicator').hide(); // hide typing after send
...
function bindChatInput() {
    $('#chat_message_input').off('keydown').on('keydown', function(e) {
    ...
    // Typing indicator — show/hide existing div
    $('#chat_message_input').off('input').on('input', function() {
...
$(document).ready(function() {
    ...
    // Auto-reload every 5 seconds when open
