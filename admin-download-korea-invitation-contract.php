...
$stmt = $conn->prepare("SELECT id, pdf_path, status FROM korea_invitation_contracts WHERE id = ? AND status = 'signed' LIMIT 1");
...
$filename = 'korea_invitation_contract_' . $contractId . '.pdf';
