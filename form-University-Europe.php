...
$agent_ids = [1, 2, 10,12,13,14,15,17,18,27,28,34,35,54,55,56,57,58,62,63,64,65,66,67,68,69];
...
// âœ… FIXED: If reloading saved application, but no university_id in URL â€” use saved values
...
<div class="form-container">
  <h2>Student Application Form â€“ <?= htmlspecialchars($universityName) ?></h2>
...
<select name="nationality" class="select2-country" required>
  ...
  <select name="bachelor_program" class="select2" style="width:100%;">
    ...
    <option value="BA Communication Design">BA Communication Design</option>
<option value="BA Design and Management Studies">BA Design and Management Studies</option>
<option value="BA Digital Product Management">BA Digital Product Management</option>
<option value="BA Film and Motion Design">BA Film and Motion Design</option>
<option value="BA Game Design">BA Game Design</option>
<option value="BA Hotel Management (dual)">BA Hotel Management (dual)</option>
<option value="BA Illustration">BA Illustration</option>
<option value="BA Photography and New Media">BA Photography and New Media</option>
<option value="BA Sports Science (Fitness and Health)">BA Sports Science (Fitness and Health)</option>
<option value="BA Sports Science (Training and Performance)">BA Sports Science (Training and Performance)</option>
<option value="BA UI/UX Design">BA UI/UX Design</option>
<option value="BA Visual Communication">BA Visual Communication</option>
<option value="BSc Business Psychology">BSc Business Psychology</option>
<option value="BSc Business and Management Studies">BSc Business and Management Studies</option>
<option value="BSc Digital Business and Data Science">BSc Digital Business and Data Science</option>
<option value="BSc Digital Media and Marketing">BSc Digital Media and Marketing</option>
<option value="BSc Health Management">BSc Health Management</option>
<option value="BSc Psychology">BSc Psychology</option>
<option value="BSc Software Engineering">BSc Software Engineering</option>
<option value="BSc Software Engineering (Dual)">BSc Software Engineering (Dual)</option>
<option value="BSc Sport and Event Management">BSc Sport and Event Management</option>
  ...
  <select name="masters_program" class="select2" style="width:100%;">
    <option value="">Please Select</option>
    <option value="Communication Design, M.A.">Communication Design, M.A.</option>
<option value="Design Leadership, M.A.">Design Leadership, M.A.</option>
<option value="Digital Content Creation, M.A.">Digital Content Creation, M.A.</option>
<option value="Generative Design and AI, M.A.">Generative Design and AI, M.A.</option>
<option value="Innovation Design Management, M.A.">Innovation Design Management, M.A.</option>
<option value="International Sport and Event Management, M.A.">International Sport and Event Management, M.A.</option>
<option value="Marketing Management, M.A.">Marketing Management, M.A.</option>
<option value="New Media Design, M.A.">New Media Design, M.A.</option>
<option value="Photography, M.A.">Photography, M.A.</option>
<option value="Visual and Experience Design, M.A.">Visual and Experience Design, M.A.</option>
<option value="Digital Health Transformation, M.B.A.">Digital Health Transformation, M.B.A.</option>
<option value="Digital Technology, M.B.A.">Digital Technology, M.B.A.</option>
<option value="Diplomacy, M.B.A.">Diplomacy, M.B.A.</option>
<option value="Financial Risk Management, M.B.A.">Financial Risk Management, M.B.A.</option>
<option value="Health Service Management, M.B.A.">Health Service Management, M.B.A.</option>
<option value="Health and Safety Leadership, M.B.A.">Health and Safety Leadership, M.B.A.</option>
<option value="International Business, M.B.A.">International Business, M.B.A.</option>
<option value="Investment Banking, M.B.A.">Investment Banking, M.B.A.</option>
<option value="Management Consulting, M.B.A.">Management Consulting, M.B.A.</option>
<option value="Marketing Management, M.B.A.">Marketing Management, M.B.A.</option>
<option value="Master of Business Administration, M.B.A.">Master of Business Administration, M.B.A.</option>
<option value="Project Management, M.B.A.">Project Management, M.B.A.</option>
<option value="Sales Management, M.B.A.">Sales Management, M.B.A.</option>
<option value="Shipping and Logistics, M.B.A.">Shipping and Logistics, M.B.A.</option>
<option value="Sports Management, M.B.A.">Sports Management, M.B.A.</option>
<option value="Sustainable Water Management, M.B.A.">Sustainable Water Management, M.B.A.</option>
<option value="Asset Management, M.Sc.">Asset Management, M.Sc.</option>
<option value="Data Science, M.Sc.">Data Science, M.Sc.</option>
<option value="Digital Transformations, M.Sc.">Digital Transformations, M.Sc.</option>
<option value="International Business Management, M.Sc.">International Business Management, M.Sc.</option>
<option value="International Logistics and Transportation Management, M.Sc.">International Logistics and Transportation Management, M.Sc.</option>
<option value="International Public Health Management, M.Sc.">International Public Health Management, M.Sc.</option>
<option value="Prevention and Therapy Management, M.Sc.">Prevention and Therapy Management, M.Sc.</option>
<option value="Psychology Coaching and Counseling, M.Sc.">Psychology Coaching and Counseling, M.Sc.</option>
<option value="Software Engineering, M.Sc.">Software Engineering, M.Sc.</option>
...
<div class="form-step" id="step5">
  ...
  <label>Study Gap â€“ Is there a gap of 3 months or more?</label>
  <div class="radio-group">
...
<!-- Chat Bubble -->
<div id="chat-bubble">
  <button onclick="openChatWindow()">ðŸ’¬ Chat with Us</button>
</div>

<!-- Chat Bubble -->
<div id="chat-bubble">
  <button>
    ðŸ’¬ Chat with Us <span id="chat-badge" style="display:none;">1</span>
  </button>
</div>
...
<div id="chat-window">
  <div class="chat-header">
    Chat Support
    <span style="cursor:pointer;" onclick="$('#chat-window').hide();">âœ–</span>
  </div>
...
<script>
  document.addEventListener('DOMContentLoaded', () => {
    flatpickr("input[type='date']", {
      ...
      altFormat: "F j, Y",
      maxDate: "today",
      defaultDate: null, // âœ… No default prefilled date
      allowInput: true
    });
  });
</script>
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const iti = window.intlTelInput(phoneInput, {
    initialCountry: "auto",
    separateDialCode: true, // âœ… Show +code outside of input
