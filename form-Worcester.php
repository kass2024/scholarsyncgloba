...
<div class="form-step active" id="step1">
  ...
  <select name="masters_program" class="select2" style="width:100%;">
    <option value="">Please Select</option>
    <option value="MS_BusinessAnalytics">Master of Science - Business Analytics</option>
    <option value="MS_FinTech">Master of Science - Financial Technology (FinTech)</option>
    <option value="MBA_Analytics">Master of Business Administration - Analytics</option>
    <option value="MS_InformationTechnology">Master of Science - Information Technology</option>
    <option value="MS_SupplyChainAnalytics">Master of Science - Operations and Supply Chain Analytics</option>
  </select>
</div>
